...
singularity exec --nv --overlay /scratch/dh3553/ml_life_cycle_project/vldb_sds_env.ext3:ro /scratch/work/public/singularity/cuda11.0-cudnn8-devel-ubuntu18.04.sif /bin/bash
...
singularity exec --overlay /scratch/dh3553/ml_life_cycle_project/vldb_sds_env.ext3:ro /scratch/work/public/singularity/ubuntu-20.04.1.sif /bin/bash
